...
begin
	...
	select 
		...
		CASE WHEN TRY_CONVERT(datetime, ISNULL(payment_date, CAST('1900-01-01' as date))) IS NULL THEN CAST('1900-01-01' as date)
...
begin
	...
	insert into edw_payments.dbo.dim_payments(
		payment_SK,
		payment_code,
		payment_mode,
		payment_amount,
