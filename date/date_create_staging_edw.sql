...
go
CREATE TABLE dbo.date_asis(day varchar(4) null,
	month varchar(4) null,
	year varchar(6) null
);
go
CREATE TABLE dbo.date_valid(day varchar(4) not null,
	month varchar(4) not null,
	year varchar(6) not null,
	invalid_flag varchar(10) not null
);
go 
CREATE TABLE dbo.date_reception(date_sur_key integer primary key,
